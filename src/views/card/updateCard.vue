...
export default {
  ...
  methods: {
    ...
    update() {
      ...
      upcreditcard(this.userId, this.item.cardNo, this.item.securityCode, this.item.expiredTime, this.item.billDay, this.item.repaymentDay, '20000',this.empowerToken).then(res => {
