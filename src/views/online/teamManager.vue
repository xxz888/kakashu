  ...
  <div>
    ...
    <div class="tabs">
      ...
      <div class="profit_share_cont" @click="gonext(L1.level)">
        <div class="themeTitle">直推&nbsp;&nbsp;({{L1Count}}人)</div>
        <div class="user">
          <div class="left">
      ...
      <div class="profit_share_cont" @click="gonext(L2.level)">
        <div class="themeTitle">间推&nbsp;&nbsp;({{L2Count}}人)</div>
        <div class="user">
          <div class="left">
            <div class="userTitle">在线收款</div>
            <div>
      ...
      <div class="profit_share_cont" @click="gonext(L3.level)">
        <div class="themeTitle">二级间推&nbsp;&nbsp;({{L3Count}}人)</div>
        <div class="user">
          <div class="left">
            <div class="userTitle">在线收款</div>
            <div>
      ...
      <div class="profit_share_cont">
        <div class="themeTitle">总计&nbsp;&nbsp;({{L1Count+L2Count+L3Count}}人)</div>
        <div class="user">
          <div class="left">
            <div class="userTitle">在线收款</div>
            <div>
